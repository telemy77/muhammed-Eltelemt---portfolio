...
export default function AdminNewProjectPage() {
  ...
  const [coverImage, setCoverImage] = useState("/images/projects/comment-stamper.png");
  const [technologies, setTechnologies] = useState("C#, Revit API, .NET");
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm mt-0.5">
            Add a new engineering project or automation plugin to your portfolio.
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[10px] text-slate-500">
                Tip: Copy image paths from the media library. Default: /images/projects/comment-stamper.png
              </p>
            </div>
